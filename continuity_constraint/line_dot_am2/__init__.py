...
def stereogramize(d=0, v=0):
    ...
    # dots
    draw.rectangle((int(sz / 2) - int(f / 2) + d*2, int(sz / 2) - int(f / 2),
                    int(sz / 2) + int(f / 2) + d*2, int(sz / 2) + int(f / 2)),
                   fill=(0, 0, 0), outline=None)
#    draw.rectangle((int(sz / 2) - int(f / 2) + d, int(sz / 2) - int(f / 2),
#                    int(sz / 2) + int(f / 2) + d, int(sz / 2) + int(f / 2)),
#                   fill=(0, 0, 0), outline=None)

    draw2.rectangle((int(sz / 2) - int(f / 2) - d*2, int(sz / 2) - int(f / 2),
                     int(sz / 2) + int(f / 2) - d*2, int(sz / 2) + int(f / 2)),
                    fill=(0, 0, 0), outline=None)
#    draw2.rectangle((int(sz / 2) - int(f / 2) - d, int(sz / 2) - v - int(ll / 2),
#                     int(sz / 2) + int(f / 2) - d, int(sz / 2) - v - int(ll / 2) - int(f)),
#                    fill=(0, 0, 0), outline=None)
...
def ls(t):
    ...
    draw.rectangle((int(sz / 2) - int(f / 2) + d*t, int(sz / 2) + int(ll / 2),
                    int(sz / 2) + int(f / 2) + d*t, int(sz / 2) - int(ll / 2)),
                   fill=(0, 0, 0), outline=None)
