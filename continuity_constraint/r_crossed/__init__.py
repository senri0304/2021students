...
disparity = 0 # 3.0pix, approximately 3*1.5 = 4.5'
...
def fixation(d):
    ...
    d.rectangle((int(sz / 2) - f * 3, int(sz / 2) + eccentricity + f,
...
def stereogramize(d, fork=False):
    ...
    if fork is False:
        draw.rectangle((int(sz / 2) - int(f / 2) + distance*3 + d, int(sz / 2) + int(ll / 2),
                        int(sz / 2) + int(f / 2) + distance*3 + d, int(sz / 2) - int(ll / 2)),
                       fill=(0, 0, 0), outline=None)
        draw2.rectangle((int(sz / 2) - int(f / 2) + distance * 3 - d, int(sz / 2) + int(ll / 2),
                         int(sz / 2) + int(f / 2) + distance * 3 - d, int(sz / 2) - int(ll / 2)),
                        fill=(0, 0, 0), outline=None)

    # dots
    draw.rectangle((int(sz / 2) + int(f / 2) - distance*3 - disparity, int(sz / 2) + distance + int(ll / 2),
                    int(sz / 2) - int(f / 2) - distance*3 - disparity, int(sz / 2) + distance + int(f) + int(ll / 2)),
                   fill=(0, 0, 0), outline=None)
    ...
    # bar
    draw2.rectangle((int(sz / 2) - int(f / 2) - distance*3 + disparity, int(sz / 2) + int(ll / 2),
                     int(sz / 2) + int(f / 2) - distance*3 + disparity, int(sz / 2) - int(ll / 2)),
