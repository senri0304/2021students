...
var = list(np.repeat(variation, rept*len(variation3)))
var3 = list(np.repeat(variation3, 3))*len(variation)
...
def set_polygon(seq, seq3):
    ...
    L = pyglet.resource.image('stereograms/ls' + str(seq) + '.png')
