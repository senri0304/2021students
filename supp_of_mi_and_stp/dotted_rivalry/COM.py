...
continuity2 = list(np.repeat(continuity, rept))
...
def set_polygon(seq, seq2):
    ...
    if test_eye == 'l':
        ...
        R = pyglet.resource.image('stereograms/' + str(seq) + 'ls' + str(seq2) + '1.png')
        R = pyglet.sprite.Sprite(R)
        R.x = cntx + deg1 * iso + cal - R.width / 2.0
        R.y = cnty - R.height / 2.0
        L = pyglet.resource.image('stereograms/ls1.png') # the test bar
        L = pyglet.sprite.Sprite(L)
        L.x = cntx - deg1 * iso - cal - L.width / 2.0
        L.y = cnty - L.height / 2.0
    else:
        R = pyglet.resource.image('stereograms/ls1.png')
        R = pyglet.sprite.Sprite(R)
        R.x = cntx + deg1 * iso + cal - R.width / 2.0
        R.y = cnty - R.height / 2.0
        L = pyglet.resource.image('stereograms/' + str(seq) + 'ls' + str(seq2) + '1.png') # the test bar
        L = pyglet.sprite.Sprite(L)
        L.x = cntx - deg1 * iso - cal - L.width / 2.0
        L.y = cnty - L.height / 2.0
