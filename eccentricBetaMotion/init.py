...
# 中央から0.5°偏位した大きさ10′のfilled circle
img = Image.new("RGB", (sz, sz), (lb, lb, lb))
draw = ImageDraw.Draw(img)

draw.ellipse((int(sz / 2 - deg1 / 4 - deg1 / 16), int(sz / 2 - deg1 / 16),
              int(sz / 2 - deg1 / 4 + deg1 / 16), int(sz / 2 + deg1 / 16)), fill=(0, 0, 0))

fixation()

basename = os.path.basename('left_half.png')
...
basename = os.path.basename('right_half.png')
img.save(os.path.join(to_dir, basename), quality=100)
